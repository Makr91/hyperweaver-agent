...
- How does this limitation affect your use of Hyperweaver Agent?
...
```bash
# Current limitation:
curl "http://127.0.0.1:9420/api/current-endpoint"

# Proposed feature:
curl "http://127.0.0.1:9420/api/new-feature-endpoint"
```
